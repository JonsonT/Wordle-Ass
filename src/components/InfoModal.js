              ...
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 sm:mt-0 sm:ml-4">
                    <Dialog.Title
                      as="h3"
                      className="text-xl leading-6 font-medium text-gray-900 flex justify-between"
                    >
                      {strings.TEXT_INFO_HEADLINE}

                      <button
                        type="button"
                        className="rounded-md text-gray-300 hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400"
                        onClick={() => setOpen(false)}
                      >
                        <span className="sr-only">
                          {strings.MODAL_CLOSE_WINDOW}
                        </span>
                        <svg
                          className="h-6 w-6"
                    ...
                    <div className="mt-2">
                      ...
                      <p className="my-4 font-bold">
                        {strings.TEXT_INFO_CONTENT_4}
                      </p>

                      <p className="my-4">{strings.TEXT_INFO_CONTENT_5}</p>
                      <div className="flex">
                        <Word
                          wordArray={strings.TEXT_INFO_EXAMPLE_WORD_MATCH}
                        />
                      </div>
                      ...
                      <div className="flex">
                        <Word
                          wordArray={strings.TEXT_INFO_EXAMPLE_WORD_OCCUR}
                        />
                      </div>
                      ...
                      <div className="flex">
                        <Word
                          wordArray={strings.TEXT_INFO_EXAMPLE_WORD_NOTOCCUR}
                        />
                      </div>
