...
export default function Keyboard() {
  ...
  const KeyboardElement = (props) => {
    return props.keyGrid.map((l, i) => (
      <div key={i} className="flex justify-center grow py-0.5">
        {l.map((k, ii) => {
          let classList = [
            "border",
            "w-16",
